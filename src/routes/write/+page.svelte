...
<div class="flex flex-col items-start justify-center gap-8 sm:gap-12 p-3">
  ...
  <div id="form-details" class="w-full flex flex-col gap-6 md:grid  md:grid-cols-2 mb-4">
    ...
    <form {...createCheckout.preflight(AddressDetailsSchema)} enctype="multipart/form-data" class="flex flex-col gap-6">
      ...
      <div id="address" class="flex flex-col gap-2">
        ...
        <label>
          Address: <input {...createCheckout.fields.address.as('text')} required />
        </label>
        <label>
          Address (2): <input {...createCheckout.fields.addressLine2.as('text')} />
        </label>
        <label>
          Postal Code: <input {...createCheckout.fields.postalCode.as('text')} required />
        </label>
        <label>
          City: <input {...createCheckout.fields.city.as('text')} required />
        </label>
        <label>
          Country:
          <select {...createCheckout.fields.country.as('select')}>
